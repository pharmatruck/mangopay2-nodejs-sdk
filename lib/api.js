...
Api.prototype = {
    ...
    _servicesLoader: function () {
        ...
        var servicesRoot, modelsRoot
        try {
            servicesRoot = require.context("./services", true, /\.js$/);
            ...
            self.models = {};
            modelsRoot = require.context("./models", true, /\.js$/);
            ...
            servicesRoot = path.join(__dirname, 'services');
            ...
            modelsRoot = path.join(__dirname, 'models');
            self.models = {};
