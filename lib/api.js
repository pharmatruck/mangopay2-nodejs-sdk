...
Api.prototype = {
    ...
    _servicesLoader: function() {
        ...
        var servicesRoot = path.join(__dirname, 'services'); - commented out for manual fix
        console.log(__dirname)
        console.log(__filename)
        console.log(path.join(__dirname, 'services'))
        console.log(path.resolve(__dirname, 'services'))
        
        var servicesRoot = './services'
        ...
        // var modelsRoot = path.join(__dirname, 'models'); - commented out for manual fix
        var modelsRoot = './models'
        self.models = {};
